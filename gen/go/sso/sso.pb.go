...
type RegisterRequest struct {
	...
	Email    string `protobuf:"bytes,1,opt,name=email,proto3" json:"email,omitempty"`       //  Email of the user register.
	Password string `protobuf:"bytes,2,opt,name=password,proto3" json:"password,omitempty"` // Password of the user register.
}
...
type IsAdminRequest struct {
	...
	IsAdmin int64 `protobuf:"varint,1,opt,name=is_admin,json=isAdmin,proto3" json:"is_admin,omitempty"` // User ID to validate.
}
...
func (x *IsAdminRequest) GetIsAdmin() int64 {
	if x != nil {
		return x.IsAdmin
	}
	return 0
...
type IsAdminResponse struct {
	...
	IsAdmin bool `protobuf:"varint,1,opt,name=is_admin,json=isAdmin,proto3" json:"is_admin,omitempty"` // Indicates wheter the user is admin.
}
...
var file_sso_sso_proto_rawDesc = []byte{
	...
	0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x2b, 0x0a, 0x0e, 0x49, 0x73, 0x41, 0x64, 0x6d,
	0x69, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x19, 0x0a, 0x08, 0x69, 0x73, 0x5f,
	0x61, 0x64, 0x6d, 0x69, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x07, 0x69, 0x73, 0x41,
	0x64, 0x6d, 0x69, 0x6e, 0x22, 0x2c, 0x0a, 0x0f, 0x49, 0x73, 0x41, 0x64, 0x6d, 0x69, 0x6e, 0x52,
	...
	0x42, 0x16, 0x5a, 0x14, 0x72, 0x6f, 0x6d, 0x61, 0x6e, 0x6f, 0x76, 0x2e, 0x73, 0x73, 0x6f, 0x2e,
